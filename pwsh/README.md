...
It keeps the firstmate idea but replaces the bash/tmux toolbelt with PowerShell scripts and psmux.
...
- `fm-spawn.ps1` creates an isolated git worktree, a psmux window, task metadata, and an optional agent launch.
